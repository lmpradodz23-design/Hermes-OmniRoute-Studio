...
DEFAULT_CONFIG = {
    ...
    "security": {
        ...
        "redact_secrets": True,
        # Core-enforced privacy boundary. When enabled, model requests may only
        # target loopback providers and network-capable tools are denied before
        # dispatch. This is snapshotted when an agent starts.
        "local_only": False,
...
OPTIONAL_ENV_VARS = {
    ...
    "XIAOMI_API_KEY": {
        "description": "Xiaomi MiMo API or Token Plan key for MiMo models (mimo-v2.5-pro, mimo-v2.5, mimo-v2-pro, mimo-v2-omni, mimo-v2-flash)",
        "prompt": "Xiaomi MiMo API Key",
        "url": "https://mimo.mi.com/docs/en-US/tokenplan/integration/hermes-agent",
        "password": True,
        "category": "provider",
    },
    "XIAOMI_BASE_URL": {
        "description": "Xiaomi MiMo base URL override; paste the exclusive Token Plan URL or leave empty for https://api.xiaomimimo.com/v1",
        "prompt": "Xiaomi API or Token Plan base URL (leave empty for pay-as-you-go default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
