...
export const zh: Translations = {
  ...
  settings: {
    ...
    omniroute: {
      title: 'OmniRoute 本地路由器',
      description: '通过本地 OmniRoute 网关路由 Hermes、发现模型，并保留经过验证的备用链。',
      endpoint: '本地端点',
      checking: '正在检查 OmniRoute…',
      online: '在线',
      offline: '离线',
      configured: '已配置',
      ...
      configuring: '正在配置…',
      configureSuccess: 'OmniRoute Studio 已启用 MoA、委派和跨对话记忆。',
      configureFailed: '无法配置 OmniRoute',
      fallbackDescription: '回退选择由 OmniRoute 负责，Hermes 不再运行相互竞争的回退链。',
      cavemanTitle: 'Caveman 令牌压缩',
      cavemanDescription: '通过 OmniRoute 减少发送给模型的上下文；需要比较原始输出时可将其关闭。',
      cavemanEnabled: 'Caveman 已启用',
      cavemanDisabled: 'Caveman 已关闭',
      cavemanUnavailable: '此设备上无法使用 OmniRoute CLI。',
      cavemanFailed: '无法更改 Caveman 压缩设置'
    },
    customEndpoints: {
      ...
      saveFailed: '保存失败',
      reachable: '端点可访问。',
      reachableModels: count => `端点可访问，找到 ${count} 个模型。`,
