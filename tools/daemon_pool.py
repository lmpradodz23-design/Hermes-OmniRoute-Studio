    ...
    def _adjust_thread_count(self) -> None:
        ...
        if num_threads < self._max_workers:
            ...
            if hasattr(self, "_create_worker_context"):
                # Python 3.14+: _worker(executor_ref, WorkerContext, queue).
                worker_args = (
                    executor_ref,
                ...
                # Python 3.8–3.13: _worker(executor_ref, queue,
            ...
            t = threading.Thread(name=thread_name, target=_worker, args=worker_args, daemon=True)
            t.start()
            self._threads.add(t)
