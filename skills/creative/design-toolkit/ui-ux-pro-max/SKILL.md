...
`<skill-directory>` means the directory containing this `SKILL.md`. Resolve it from the loaded skill path at runtime; never assume a Claude-specific installation directory.
