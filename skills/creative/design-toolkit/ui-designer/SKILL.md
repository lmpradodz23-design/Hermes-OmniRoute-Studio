...
Map the upstream `Task` tool to Hermes delegation when it is enabled and allowed. Otherwise perform the same stages serially in the current task; do not omit the design-system, PRD, or verification artifacts.
